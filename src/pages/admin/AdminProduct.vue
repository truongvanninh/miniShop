        ...
        <b-form-group class="mb-0">
           <b-input-group>
            <b-input-group-text slot="append" style="cursor: pointer;">
                <strong class="text-danger" @click="clearFilter()"> X</strong>
            </b-input-group-text>
        ...
        <b-col>
          <form  @submit.stop.prevent="handleSubmit">
            ...
            <b-form-input type="text"
                    ...
                    ></b-form-input> <br>
            <b-form-select v-model="updateProduct.type" :options="addSelect" class="mb-3"></b-form-select><br>
            <div>
...
const updateProduct = {nameImage: '',image: '', name: '', price: '', description: '', type:''}
  ...
  data () {
    return {
      ...
      selectPR: [
        ...
        { value: 'veston-nam', text: 'Veston nam' },
        { value: 'veston-nu', text: 'Veston nữ' },
        { value: 'quan', text: 'Quần' },
        { value: 'ao-so-mi', text: 'Áo sơ mi'}
      ],
      addSelect: [
        { value: 'veston-nam', text: 'Veston nam' },
        { value: 'veston-nu', text: 'Veston nữ' },
  ...
  methods: {
    ...
    addProduct () {
      ...
      this.uploadTask.then(snapshot => {
        ...
        // this.$firebaseRefs.Product.child(this.infoProduct['name']).set(this.infoProduct)  // Thêm với key = tên
        this.$firebaseRefs.Product.push(this.infoProduct)                              // Thêm với key = auto firebase
    ...
    infoUpdate (item, index, button) {
      ...
      this.updateProduct.name = item.name
      this.updateProduct.image= item.image
      this.updateProduct.nameImage= item.nameImage
      this.updateProduct.price= item.price
      this.updateProduct.type= item.type
      this.updateProduct.description = item.description
